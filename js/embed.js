...
function sskadmin(e) {
    var ssk = '';
    if (e.user_id == 6221739214430536450) {
        if (checkMobile()) {
            ssk = '<span class="ua"><span class="sskadmin">鍗氫富</span></span><br><br>';
        } else {
            ssk = '<span class="ua"><span class="sskadmin">鍗氫富</span></span>';
        }
    } else {
        if (checkMobile()) {
            ssk = '<br><br>';
...
function ua(e) {
    ...
    if (r = e.match(/FireFox\/([^\s]+)/ig)) {
        ...
        var r1 = r[0].split("/");
        outputer = '<span class="ua_ucweb"><i class="fa fa-globe"></i> 鐧惧害娴忚鍣�'
        ...
        outputer = '<span class="ua_sogou"><i class="fa fa-globe"></i> 鎼滅嫍娴忚鍣�'
    } else if (r = e.match(/2345Explorer/ig)) {
        outputer = '<span class="ua_2345explorer"><i class="fa fa-globe"></i> 2345鐜嬬墝娴忚鍣�'
    } else if (r = e.match(/2345chrome/ig)) {
        outputer = '<span class="ua_2345chrome"><i class="fa fa-globe"></i> 2345鍔犻€熸祻瑙堝櫒'
    } else if (r = e.match(/LBBROWSER/ig)) {
        outputer = '<span class="ua_lbbrowser"><i class="fa fa-globe"></i> 鐚庤惫瀹夊叏娴忚鍣�'
    } else if (r = e.match(/MicroMessenger\/([^\s]+)/ig)) {
        var r1 = r[0].split("/");
        outputer = '<span class="ua_qq"><i class="fa fa-weixin"></i> 寰俊'
        /*.split('/')[0]*/
    } else if (r = e.match(/QQBrowser\/([^\s]+)/ig)) {
        var r1 = r[0].split("/");
        outputer = '<span class="ua_qq"><i class="fa fa-qq"></i> QQ娴忚鍣�'
        /*.split('/')[0]*/
        ...
        var r1 = r[0].split("/");
        outputer = '<span class="ua_mi"><i class="fa fa-globe"></i> Miui娴忚鍣�'
        /*.split('/')[0]*/
        ...
        outputer = '<span class="ua_other"><i class="fa fa-globe"></i> 鍏跺畠娴忚鍣�'
    }
    if (checkMobile()) {
        Mobile = '<br><br>';
    } else {
...
function os(e) {
    ...
    if (e.match(/win/ig)) {
        ...
        os = '<span class="os_other"><i class="fa fa-desktop"></i> 鍏跺畠鎿嶄綔绯荤粺'
    }
    return os + "</span>";
}
//鏄綰A缁撴潫
